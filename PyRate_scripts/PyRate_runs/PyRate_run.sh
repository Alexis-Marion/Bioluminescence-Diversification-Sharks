...
echo "python ../../PyRate/PyRate.py  ../Data/Occ_gn_Squali_PyRate.py -fixShift epochs_rate_shift_5_Myrs.txt -j \$1 -qShift ../Preservation_Test/epochs.txt -mG -n 20000000 -s 20000 -N 23" > tmp_script.sh
